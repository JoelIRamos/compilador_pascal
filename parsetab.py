...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','otrocompi.py',68),
  ('statement -> expression','statement',1,'p_statement_expr','otrocompi.py',73),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','otrocompi.py',78),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','otrocompi.py',79),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','otrocompi.py',80),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','otrocompi.py',81),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','otrocompi.py',89),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','otrocompi.py',94),
  ('expression -> NUMBER','expression',1,'p_expression_number','otrocompi.py',99),
  ('expression -> NAME','expression',1,'p_expression_name','otrocompi.py',104),
]
