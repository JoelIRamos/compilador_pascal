...
_lr_productions = [
  ...
  ('Program -> PROGRAM ID LEFTBRACKET variable block RIGHTBRACKET','Program',6,'p_program','Parser.py',25),
  ('Program -> PROGRAM ID LEFTBRACKET block RIGHTBRACKET','Program',5,'p_program_without_vars','Parser.py',33),
  ('variable -> VAR variables COLON datatype SEMICOLON','variable',5,'p_variable','Parser.py',41),
  ('variable -> variable variable','variable',2,'p_variable_repetition','Parser.py',50),
  ...
  ('statement -> statement statement','statement',2,'p_statements','Parser.py',117),
  ('writestatement -> WRITE LEFTPARENTHESIS expression RIGHTPARENTHESIS SEMICOLON','writestatement',5,'p_writestatement','Parser.py',140),
  ('assignstatement -> ID ASSIGN expression SEMICOLON','assignstatement',4,'p_assignstatement_classic','Parser.py',148),
  ('assignstatement -> ID PLUSPLUS SEMICOLON','assignstatement',3,'p_assignstatement_increment_decrement','Parser.py',156),
  ('assignstatement -> ID MINUSMINUS SEMICOLON','assignstatement',3,'p_assignstatement_increment_decrement','Parser.py',157),
  ('ifstatement -> IF LEFTPARENTHESIS expression RIGHTPARENTHESIS THEN LEFTBRACKET statement RIGHTBRACKET','ifstatement',8,'p_ifstatement','Parser.py',165),
  ('ifstatement -> IF LEFTPARENTHESIS expression RIGHTPARENTHESIS THEN LEFTBRACKET statement RIGHTBRACKET ELSE LEFTBRACKET statement RIGHTBRACKET','ifstatement',12,'p_if_else_statement','Parser.py',173),
  ('whileloop -> WHILE LEFTPARENTHESIS expression RIGHTPARENTHESIS DO LEFTBRACKET statement RIGHTBRACKET','whileloop',8,'p_whileloop','Parser.py',181),
  ('forloop -> FOR LEFTPARENTHESIS ID ASSIGN expression SEMICOLON expression SEMICOLON ID increment_decrement RIGHTPARENTHESIS LEFTBRACKET statement RIGHTBRACKET','forloop',14,'p_forloop','Parser.py',189),
  ('increment_decrement -> PLUSPLUS','increment_decrement',1,'p_increment_decrement','Parser.py',199),
  ('increment_decrement -> MINUSMINUS','increment_decrement',1,'p_increment_decrement','Parser.py',200),
  ('expression -> logical_expression','expression',1,'p_expression','Parser.py',208),
  ('expression -> relational_expression','expression',1,'p_expression','Parser.py',209),
  ('expression -> arithmetic_expression','expression',1,'p_expression','Parser.py',210),
  ('expression -> ID','expression',1,'p_expression','Parser.py',211),
  ('expression -> STRING','expression',1,'p_expression','Parser.py',212),
  ('logical_expression -> relational_expression AND relational_expression','logical_expression',3,'p_logical_expression','Parser.py',220),
  ('logical_expression -> relational_expression OR relational_expression','logical_expression',3,'p_logical_expression','Parser.py',221),
  ('logical_expression -> LEFTPARENTHESIS logical_expression RIGHTPARENTHESIS','logical_expression',3,'p_logical_expression_parenthesis','Parser.py',229),
  ('relational_expression -> arithmetic_expression GREATER arithmetic_expression','relational_expression',3,'p_relational_expression','Parser.py',237),
  ('relational_expression -> arithmetic_expression LESSER arithmetic_expression','relational_expression',3,'p_relational_expression','Parser.py',238),
  ('relational_expression -> arithmetic_expression GREATEREQUAL arithmetic_expression','relational_expression',3,'p_relational_expression','Parser.py',239),
  ('relational_expression -> arithmetic_expression LESSEREQUAL arithmetic_expression','relational_expression',3,'p_relational_expression','Parser.py',240),
  ('relational_expression -> arithmetic_expression EQUAL arithmetic_expression','relational_expression',3,'p_relational_expression','Parser.py',241),
  ('relational_expression -> STRING EQUAL STRING','relational_expression',3,'p_relational_expression','Parser.py',242),
  ('relational_expression -> LEFTPARENTHESIS relational_expression RIGHTPARENTHESIS','relational_expression',3,'p_relational_expression_parenthesis','Parser.py',250),
  ('relational_expression -> BOOLEAN','relational_expression',1,'p_relational_expression_unit','Parser.py',258),
  ('arithmetic_expression -> arithmetic_expression PLUS arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','Parser.py',266),
  ('arithmetic_expression -> arithmetic_expression MINUS arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','Parser.py',267),
  ('arithmetic_expression -> arithmetic_expression TIMES arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','Parser.py',268),
  ('arithmetic_expression -> arithmetic_expression DIVIDE arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','Parser.py',269),
  ('arithmetic_expression -> LEFTPARENTHESIS arithmetic_expression RIGHTPARENTHESIS','arithmetic_expression',3,'p_arithmetic_expression_parenthesis','Parser.py',277),
  ('arithmetic_expression -> ID','arithmetic_expression',1,'p_arithmetic_expression_modifier','Parser.py',285),
  ('arithmetic_expression -> INTEGER','arithmetic_expression',1,'p_arithmetic_expression_modifier','Parser.py',286),
  ('arithmetic_expression -> NUMBER','arithmetic_expression',1,'p_arithmetic_expression_modifier','Parser.py',287),
