...
_lr_productions = [
  ...
  ('Program -> PROGRAM ID LEFTBRACKET variable block RIGHTBRACKET','Program',6,'p_program','parser.py',27),
  ('variable -> VAR ID variables COLON datatype SEMICOLON variable','variable',7,'p_variable','parser.py',34),
  ('variable -> empty','variable',1,'p_variable','parser.py',35),
  ('variables -> COMMA ID variables','variables',3,'p_variables','parser.py',42),
  ('variables -> empty','variables',1,'p_variables','parser.py',43),
  ('datatype -> INT','datatype',1,'p_datatype','parser.py',50),
  ('datatype -> REAL','datatype',1,'p_datatype','parser.py',51),
  ('datatype -> BOOL','datatype',1,'p_datatype','parser.py',52),
  ('datatype -> STR','datatype',1,'p_datatype','parser.py',53),
  ('block -> BEGIN SEMICOLON statement END SEMICOLON','block',5,'p_block','parser.py',60),
  ('statement -> writestatement statement','statement',2,'p_statement','parser.py',67),
  ('statement -> assignstatement statement','statement',2,'p_statement','parser.py',68),
  ('statement -> ifstatement statement','statement',2,'p_statement','parser.py',69),
  ('statement -> whileloop statement','statement',2,'p_statement','parser.py',70),
  ('statement -> forloop statement','statement',2,'p_statement','parser.py',71),
  ('statement -> empty','statement',1,'p_statement','parser.py',72),
  ('writestatement -> WRITE LEFTPARENTHESIS expression RIGHTPARENTHESIS SEMICOLON','writestatement',5,'p_writestatement','parser.py',79),
  ('assignstatement -> ID ASSIGN expression SEMICOLON','assignstatement',4,'p_assignstatement','parser.py',86),
  ('ifstatement -> IF LEFTPARENTHESIS expression RIGHTPARENTHESIS THEN LEFTBRACKET statement RIGHTBRACKET elsestatement','ifstatement',9,'p_ifstatement','parser.py',94),
  ('elsestatement -> ELSE LEFTBRACKET statement RIGHTBRACKET','elsestatement',4,'p_elsestatement','parser.py',111),
  ('elsestatement -> empty','elsestatement',1,'p_elsestatement','parser.py',112),
  ('whileloop -> WHILE LEFTPARENTHESIS expression RIGHTPARENTHESIS DO LEFTBRACKET statement RIGHTBRACKET','whileloop',8,'p_whileloop','parser.py',121),
  ('forloop -> FOR LEFTPARENTHESIS ID ASSIGN expression SEMICOLON expression SEMICOLON formodifier RIGHTPARENTHESIS LEFTBRACKET statement RIGHTBRACKET','forloop',13,'p_forloop','parser.py',134),
  ('formodifier -> ID PLUSPLUS','formodifier',2,'p_formodifier','parser.py',157),
  ('formodifier -> ID MINUSMINUS','formodifier',2,'p_formodifier','parser.py',158),
  ('expression -> simpleexpression','expression',1,'p_expression','parser.py',166),
  ('expression -> simpleexpression relationaloperators simpleexpression','expression',3,'p_expression','parser.py',167),
  ('relationaloperators -> EQUAL','relationaloperators',1,'p_relationaloperators','parser.py',174),
  ('relationaloperators -> LESSER','relationaloperators',1,'p_relationaloperators','parser.py',175),
  ('relationaloperators -> GREATER','relationaloperators',1,'p_relationaloperators','parser.py',176),
  ('relationaloperators -> LESSEREQUAL','relationaloperators',1,'p_relationaloperators','parser.py',177),
  ('relationaloperators -> GREATEREQUAL','relationaloperators',1,'p_relationaloperators','parser.py',178),
  ('simpleexpression -> term','simpleexpression',1,'p_simpleexpression','parser.py',185),
  ('simpleexpression -> term PLUS simpleexpression','simpleexpression',3,'p_simpleexpression','parser.py',186),
  ('simpleexpression -> term MINUS simpleexpression','simpleexpression',3,'p_simpleexpression','parser.py',187),
  ('simpleexpression -> term OR simpleexpression','simpleexpression',3,'p_simpleexpression','parser.py',188),
  ('term -> fact','term',1,'p_term','parser.py',195),
  ('term -> fact TIMES term','term',3,'p_term','parser.py',196),
  ('term -> fact MINUS term','term',3,'p_term','parser.py',197),
  ('term -> fact DIVIDE term','term',3,'p_term','parser.py',198),
  ('term -> fact AND term','term',3,'p_term','parser.py',199),
  ('fact -> unaryoperator ID','fact',2,'p_fact','parser.py',206),
  ('fact -> unaryoperator LEFTPARENTHESIS expression RIGHTPARENTHESIS','fact',4,'p_fact','parser.py',207),
  ('fact -> unaryoperator INTEGER','fact',2,'p_fact','parser.py',208),
  ('fact -> unaryoperator NUMBER','fact',2,'p_fact','parser.py',209),
  ('fact -> unaryoperator STRING','fact',2,'p_fact','parser.py',210),
  ('fact -> unaryoperator BOOLEAN','fact',2,'p_fact','parser.py',211),
  ('unaryoperator -> PLUS','unaryoperator',1,'p_unaryoperator','parser.py',218),
  ('unaryoperator -> MINUS','unaryoperator',1,'p_unaryoperator','parser.py',219),
  ('unaryoperator -> empty','unaryoperator',1,'p_unaryoperator','parser.py',220),
